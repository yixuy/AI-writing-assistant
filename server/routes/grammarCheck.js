        ...
        messages: [
          {
            role: "system",
            content:
              "You are a helpful assistant that checks and fixes the grammar errors in the following text. Only return the corrected text without any additional text or comments.",
          },
          {
            role: "user",
            content: text,
